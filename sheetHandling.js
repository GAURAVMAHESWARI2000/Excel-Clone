...
function handleSheetRemoval(sheet){
    sheet.addEventListener("mousedown", (e) => {
        if(e.button !==2)  return;  //not rightclick
        let allSheetFolders = document.querySelectorAll(".sheet-folder")
        ...
        let response = confirm("Your sheet will be removes permanently, Are you sure?")
        ...
        //assign By default DB to sheet 1(make sheet 1 active)
...
//remove sheet from UI and change indexes
